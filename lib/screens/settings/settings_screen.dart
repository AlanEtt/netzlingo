...
class SettingsScreen extends StatelessWidget {
      ...
      body: settingsProvider.isLoading
          ...
          : settingsProvider.error != null
              ...
              : settingsProvider.settings == null
                  ? const Center(
                      child: Text(
                          'Pengaturan belum tersedia. Harap tunggu sebentar...'),
                    )
                  : ListView(
                      ...
                      children: [
                          ...
                          onChanged: (value) {
                            if (userId.isNotEmpty) {
                              try {
                                ...
                                _showErrorSnackbar(
                                    context, 'Gagal mengubah tema: $e');
                              }
                            } else {
                              _showErrorSnackbar(
                                  context, 'Anda harus login terlebih dahulu');
                            }
                          },
                        ),
                        const Divider(),
                            ...
                            if (userId.isNotEmpty) {
                              try {
                                settingsProvider.updateNotificationSettings(
                                  ...
                                  notificationTime:
                                      settingsProvider.notificationTime,
                                );
                              } catch (e) {
                                _showErrorSnackbar(context,
                                    'Gagal mengubah pengaturan TTS: $e');
                              }
                            } else {
                              _showErrorSnackbar(
                                  context, 'Anda harus login terlebih dahulu');
                        ...
                        SwitchListTile(
                          ...
                          subtitle:
                              const Text('Aktifkan pengingat latihan harian'),
                          ...
                          onChanged: (value) {
                            if (userId.isNotEmpty) {
                              try {
                                ...
                                _showErrorSnackbar(context,
                                    'Gagal mengubah pengaturan notifikasi: $e');
                              }
                            } else {
                              _showErrorSnackbar(
                                  context, 'Anda harus login terlebih dahulu');
                        ...
                        if (settingsProvider.enableNotifications)
                          ListTile(
                            ...
                            onTap: () => _selectNotificationTime(
                                context, settingsProvider, userId),
                          ),
                        const Divider(),
                        ...
                        ListTile(
                          ...
                          subtitle: Text(
                              '${settingsProvider.dailyGoal} frasa per hari'),
                          trailing:
                              const Icon(Icons.arrow_forward_ios, size: 16),
                        ...
                        ListTile(
                          ...
                          subtitle: authProvider.currentUser != null
  ...
  Widget _buildErrorView(
      BuildContext context, SettingsProvider provider, String userId) {
    return Center(
      child: Column(
  ...
  void _showLogoutConfirmation(
    ...
    showDialog(
      context: context,
      barrierDismissible: false, // Mencegah dismissal dengan tap di luar dialog
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              ...
              print('SettingsScreen: Logout confirmation dialog closed');
              Navigator.pop(dialogContext);

              // Langsung proses logout tanpa menunggu snackbar
              print('SettingsScreen: Processing logout request');
              LogoutHelper.performLogout(context, authProvider);
            },
